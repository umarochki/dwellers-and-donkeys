...
export default class SVG extends PIXI.Graphics
{
    ...
    _svgFill(node, inherit = false)
    {
        ...
        const lineColor = stroke !== null ? this._hexToUint(stroke) : this.fill.color;
        ...
        this.lineStyle(
            stroke === null && strokeWidth === null && inherit ? this.line.width : lineWidth,
            stroke === null && inherit ? this.line.color : lineColor,
            cap === null && inherit ? this.line.cap : cap
