...
export class InputManager
{
     ...
     */
    public down(event: PIXI.InteractionEvent)
    {
    ...
    public move(event: PIXI.InteractionEvent): void
    {
        if (this.viewport.pause || !this.viewport.worldVisible)
        {
            return;
    ...
    public up(event: PIXI.InteractionEvent): void
    {
        if (this.viewport.pause || !this.viewport.worldVisible)
        {
            return;
    ...
    public getPointerPosition(event: WheelEvent): PIXI.Point
    {
