...
export class Drag extends Plugin
{
    ...
    protected last?: PIXI.IPointData | null;
     ...
     * @returns {boolean}
     */
    protected checkButtons(event: PIXI.InteractionEvent): boolean
    {
     ...
     * @returns {boolean}
     */
    protected checkKeyPress(event: PIXI.InteractionEvent): boolean
    {
    ...
    public down(event: PIXI.InteractionEvent): boolean
    {
    ...
    public move(event: PIXI.InteractionEvent): boolean
    {
        if (this.paused || !this.options.pressDrag)
        {
            return false;
    ...
    public up(event: PIXI.InteractionEvent): boolean
    {
        if (this.paused)
        {
            return false;
