...
export interface ISnapZoomOptions
{
    ...
    /** Place this PIXI.Point at center during zoom instead of center of the viewport */
...
export class SnapZoom extends Plugin
{
    ...
    constructor(parent: Viewport, options: ISnapZoomOptions = {})
    {
        ...
        if (this.options.time === 0)
        {
            ...
            parent.asContainer().scale.x = this.xScale;

            // TODO: Fix this
            
            parent.asContainer().scale.y = this.yScale;
    ...
    public update(elapsed: number): void
    {
        ...
        let oldCenter: PIXI.Point | undefined;
        ...
        else if (this.snapping)
        {
            ...
            if (!this.options.noMove)
            {
                ...
                {
                    this.parent.moveCenter(oldCenter as PIXI.Point);
                }
                else
                {
