...
export class Wheel extends Plugin
{
    ...
    protected smoothing?: PIXI.IPointData | null;
    protected smoothingCenter?: PIXI.Point | null;
    ...
    public update(): void
    {
        if (this.smoothing)
        {
            ...
            {
                oldPoint = this.parent.toLocal(point as PIXI.IPointData);
            }
            if (this.isAxisX())
            {
            ...
            else
            {
                ...
                this.parent.x += (point as PIXI.IPointData).x - newPoint.x;
                this.parent.y += (point as PIXI.IPointData).y - newPoint.y;
            }
